      ...
      <div className='post-header'>
        ...
        <div className='post-user' onClick={()=>handleFriendsId(post.id)} style={{cursor:"pointer"}}>
         ...
         {showDelete && (<div className="options">
            <button><PiSmileySad />No interesado en este Post</button>
            <button><IoVolumeMuteOutline />Mutear este usuario</button>
            <button><MdBlockFlipped />Bloquear este usuario</button>
            <button onClick={()=>handleDelete(post.id)}><AiOutlineDelete />Borrar</button>
            <button><MdReportGmailerrorred />Reportar post</button>
         </div>
      ...
      <div className="post-foot">
       <div className="post-footer">
        ...
        <div className="like-comment-details">
          <span className='post-like'>{like} Personas  que le gusta esto,</span>
          <span className='post-comment'>{comments.length} Comentarios</span>
        </div>
       ...
       {showComment && (<div className="commentSection">
        <form onSubmit={handleCommentInput}>
          <div className="cmtGroup">
              ...
              id="commentInput"
              required
              placeholder='Adicionar un commentario...'
